...
If the tool replies REJECTED, fix exactly what it names and call it again. If the brief says UNREACHABLE, record nothing for that id.
...
If the tool replies REJECTED, fix exactly what it names and call it again.
...
If the tool replies REJECTED, fix exactly what it names and call it again. Dates not in the allowed list cannot be recorded.
When every id is recorded or skipped, reply with the single word DONE."""
